...
<section>
  <div class="topnav">
    ...
    <div>
    <img src="Images/Bohemian.jpg" alt="Category 1" onclick="fillCategoryFilter('bohemian')" class="image-filter">
    <img src="Images/Rustic.jpg" alt="Category 2" onclick="fillCategoryFilter('rustic')" class="image-filter">
    <img src="Images/Minimalistic.jpg" alt="Category 3" onclick="fillCategoryFilter('minimal')" class="image-filter">
    <img src="Images/Tropical.jpg" alt="Category 4" onclick="fillCategoryFilter('tropical')" class="image-filter">
    <img src="Images/Modern.jpg" alt="Category 5" onclick="fillCategoryFilter('modern')" class="image-filter">
</div>
...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<a onclick="showProductModal(' . $row['productId'] . ')"><img src="Images/' . htmlspecialchars($row['imageName']) . '" alt="' . htmlspecialchars($row['imageName']) . '" class="product-image">' . htmlspecialchars($row['productName']) . '</a><br>';
            echo '</td>';
...
if (!empty($cheapestProducts)) {
    ...
    foreach ($cheapestProducts as $offer) {
        ...
        echo '<a onclick="showProductModal(' . $offer['productId'] . ')"><img src= "Images/' . htmlspecialchars($offer['imageName']) . '" alt="' . htmlspecialchars($offer['imageName']) . '"></a><br>';
...
?>
    ...
    <div class="product">
        <section class="one">
        <img src="Images/Desk Inspiration 1.jpg" alt="Product 1" class="my_img_2">
        <img src="Images/Desk Inspiration 2.jpg" alt="Product 2" class="my_img_2">
    ...
    <div class="product">
        <section class="one">
            <img src="Images/Tips and Ideas 1.jpg" alt="Product 1" class="my_img">
            

            
            <img src="Images/Tips and Ideas 2.jpg" alt="Product 2" class="my_img">
            

            
            <img src="Images/Tips and Ideas 3.jpg" alt="Product 3" class="my_img">

            <img src="Images/Tips and Ideas 4.jpg" alt="Product 3" class="my_img">
       
            <img src="Images/Tips and Ideas 5.jpg" alt="Product 3" class="my_img">
...
<script>
    function showProductModal(productId) {
        ...
        xhr.open('GET', 'product.php?product_id=' + productId, true);
        xhr.send();
